...
lambdas8<-c(7.1,11.1,19.47,28.19,37.17,46.35,55.7,65.2)

#plot the trade-off curves with points for strategies used
plot(lambdas11~mdd, main="Trade off Curve", ylim=c(0,70), xlab="Mean Dispersal Distance (in Patches)", ylab="Reproduction Rate at Low Density",type="l")
lines(x=mdd,y=lambdas04, lty=2, col="grey")
lines(x=mdd, y=lambdas07, lty=3, col="grey")
points(x=mdd8, y=lambdas8, col=c("navy","royalblue2","turquoise3","springgreen2","yellowgreen","goldenrod","darkorange","red"), pch=16)
legend(x="topright", legend=c("d=0.4","d=1.1","d=0.7"), lty=c(2,1,3))
